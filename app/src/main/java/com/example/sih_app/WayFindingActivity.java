...
public class WayFindingActivity extends FragmentActivity
    ...
    private void showLocationCircle(LatLng center, double accuracyRadius) {
        if (mCircle == null) {
            // location can received before map is initialized, ignoring those updat
            //
            // es
            if (mMap != null) {
    ...
    private IALocationListener mListener = new IALocationListenerSupport() {
        ...
        public void onLocationChanged(IALocation location) {
            ...
            Log.d(TAG, "new location received with coordinates: " + location.getLatitude()
                    + "," + location.getLongitude() + ", "+ location.getAccuracy() +", "+ location.getFloorCertainty());
            Toast.makeText(WayFindingActivity.this, "new location received with coordinates: " + location.getLatitude() + "  longitude "+ location.getLongitude()  + ", "+ location.getAccuracy() +", "+ location.getFloorCertainty(), Toast.LENGTH_SHORT).show();
            ...
            LatLng point = new LatLng(11.321526801938923, 75.93371506780386);
            if (mMap != null) {


                System.out.println("Point lat "+ point.latitude+ " point long "+ point.longitude);
    ...
    void log(String message)
    {
        ...
        Toast.makeText(WayFindingActivity.this, "status message "+ message, Toast.LENGTH_SHORT).show();
    }
